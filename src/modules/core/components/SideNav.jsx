...
import avatar from "../../../../public/dist/img/user2-160x160.jpg";

import '../../../../public/dist/css/adminlte.min.css' //styles
import '../../../../public/plugins/overlayScrollbars/css/OverlayScrollbars.min.css'//scroll
import '../../../../public/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js'//overflow x
        ...
        <div className="sidebar">
          ...
          <nav className="mt-2">
           ...
           with font-awesome or any other icon font library */}
              ...
              <li className="nav-header">Archivos digitales</li>
              <li className="nav-item">
              ...
              <li className="nav-header">Trámites</li>
              <li className="nav-item">
                <Link to={"employees"} className="nav-link">
                  <i className="nav-icon fas fa-users"></i>
                  <p>
